	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 offset-md-1">
				<h1><?php echo $view_data->data->title ?></h1>
			</div>
			<div class="offset-md-1 col-md-6 vac-inf">
				<span class="location">
					<?php echo $view_data->data->location ?>
				</span>
				<span class="opleiding">
					<?php
			...
			<div class="col-md-5 justify-content-end align-items-end d-flex">
				<div>
					<a class="small" href="#soll"><?php _e('Solliciteer direct', 'flexsupport'); ?>
						<svg width="79" height="27" viewBox="0 0 79 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php if ($view_data->data->image_url_original) { ?>
	<div class="full--img" style="background-image:url(<?php echo $view_data->data->image_url_original; ?>);">
	</div>
<?php } ?>
<section class="about about-vacancy">
	<div class="container">
		<div class="row">
			<div class="col-md-2 offset-md-1">
				<span class="sub">
					<?php _e('Over deze vacature', 'flexsupport'); ?>
				</span>
			</div>
			<div class="col-md-8 description">
				<h2><?php _e('Omschrijving', 'flexsupport'); ?></h2>
				<p><?php echo $view_data->data->description; ?></p>

				<h2><?php _e('Heb je nog vragen?', 'flexsupport'); ?></h2>
				<p>
					<?php echo sprintf(
						__('Neem dan eens telefonisch contact op met <b>%s</b> via <b>%s</b> of via de mail <b>%s.</b> Wij helpen jou graag verder.', 'flexsupport'),
						$view_data->data->recruiter->data->full_name,
						$view_data->data->recruiter->data->phone,
						$view_data->data->recruiter->data->email
					); ?>
				</p>
			</div>
		</div>
...
<section class="about requestform request-vac" id="aanvragen">
	<div class="container">
		<div class="row">
...
<section class="recruiter">
	<div class="container">
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<h2><?php _e('De recruiter', 'flexsupport'); ?></h2>
			...
			<div class="offset-md-2 col-md-4">
				<a class="tel" href="tel:<?php echo $view_data->data->recruiter->data->phone; ?>"><?php echo $view_data->data->recruiter->data->phone; ?></a>
			</div>
			<div class="col-md-4 justify-content-end d-flex">
				<div>
					<a class="question" href="mailto:<?php echo $view_data->data->recruiter->data->email; ?>">
						<?php echo sprintf(
							__('Stel %s een vraag'),
							$view_data->data->recruiter->data->first_name
						); ?>
						<svg width="79" height="27" viewBox="0 0 79 27" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M65.5607 0.93932L78.1213 13.5L65.5607 26.0606L63.4393 23.9393L72.3787 15L2.45844e-06 15L1.93391e-06 12L72.3787 12L63.4393 3.06064L65.5607 0.93932Z" fill="#35FFB6" />
						</svg>
