...
function flexupdate_scripts()
{
	...
	wp_enqueue_script('niceselect', get_template_directory_uri() . '/js/jquery-editable-select.min.js', array(), '1.0.0', false);
	...
	wp_enqueue_style('niceselectcss', get_template_directory_uri() . '/css/jquery-editable-select.min.css');
